...
if (!function_exists('woocommerce_output_related_products')) {
	function woocommerce_output_related_products() {
		global $woo_options;
	    woocommerce_related_products( ( $woo_options['woocommerce_product_columns'] + 2 ), ( $woo_options['woocommerce_product_columns'] + 2 ) );
	}
}
...
if (!function_exists('woocommerceframework_upsell_display')) {
	function woocommerceframework_upsell_display() {
		global $woo_options;
	    woocommerce_upsell_display( -1, ( $woo_options['woocommerce_product_columns'] + 2 ) );
	}
}
